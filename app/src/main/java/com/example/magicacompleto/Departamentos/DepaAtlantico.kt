...
class DepaAtlantico : AppCompatActivity() {
    @SuppressLint("MissingInflatedId")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_depa_atlantico)
        val amazonas1Card: CardView = findViewById(R.id.Atlantico1card)
        val amazonas2Card: CardView = findViewById(R.id.Atlantico2card)
        val amazonas3Card: CardView = findViewById(R.id.Atlantico3card)
        val amazonas4Card: CardView = findViewById(R.id.Atlantico4card)
